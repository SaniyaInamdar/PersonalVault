...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark col-12">
        <a class="navbar-brand" href="#">PersonalVault---Notes</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="doc.php">Document</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="noteindex.php">Notes<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
