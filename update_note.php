                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="update_note_process.php">
                            ...
                            <button href="http://localhost/take-note-app/" type="submit" class="btn btn-danger">Cancel</button>
                        </form>
                    </div>
                </div>
            </div>
                            ...
                            ?>
                                <li class="list-group-item mt-2">
                                    <div class="btn-group float-right">
                                        ...
                                        <a href="delete_note.php?delete=<?php echo $noteID ?>"><button type="button" class="btn btn-sm btn-light" title="Remove"><i class="fa fa-trash"></i></button></a>
                                    </div>
